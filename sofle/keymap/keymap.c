 ...
 * |      |      |      |      |      |      |                    |      |      |      | PSCR | INS  | PAUS |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | ESC  | MEH  | HYPR |      |      | ` ~  |                    | PGUP |WPREV |  UP  |WNEXT | WDEL | BSPC |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | CAPS | LSFT | LALT | LCTL |      | TAB  |,------.    ,------.| PGDN | LEFT | DOWN | RGHT | DEL  |      |
 * |------+------+------+------+------+------|| ___  |    | ___  ||------+------+------+------+------+------|
...
KC_ESC,   KC_MEH,   KC_HYPR,  XXXXXXX,  XXXXXXX,  KC_GRV,                       KC_PGUP,  KC_WPREV, KC_UP,    KC_WNEXT, KC_WDEL,   KC_BSPC, \
KC_CAPS,  KC_LSFT,  KC_LALT,  KC_LCTL,  XXXXXXX,  KC_TAB,                       KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_DEL,    XXXXXXX, \
