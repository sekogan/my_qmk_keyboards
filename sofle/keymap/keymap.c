...
[_LOWER] = LAYOUT( \
  ...
  XXXXXXX,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,                      KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_F12, \
  XXXXXXX,  KC_EQL,   KC_MINS,  KC_PLUS,  KC_UNDS,  XXXXXXX,                      KC_SCLN,  KC_DQUO,  KC_SLSH,  KC_BSLS,  KC_PIPE,  XXXXXXX, \
