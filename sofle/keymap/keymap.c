...
#define MT_ENT      LT(NUMPAD, KC_ENT)
 ...
 * `-------------+------+------+------+-.------------.    ,------------.-+------+------+------+-------------'
 *               |Super | LALT |LCTRL |/LOWER / SPC  /    \MT_ENT\RAISE \|RCTRL | RALT |Super |
 *               |      |      |      /      /      /      \      \      \      |      |      |
 *               `---------------------------------'        `---------------------------------'
...
OSM_LSFT, KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_MPLY,  XXXXXXX,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  OSM_RSFT, \
                    MT_LGUI,  KC_LALT,  KC_LCTRL, KC_LOWER, KC_SPC,   MT_ENT,   KC_RAISE, KC_RCTRL, KC_RALT,  MT_RGUI \
),
 ...
 * | ___  | ` ~  |  !   |  ?   | / ?  | \ |  |`------'    `------'|  {   |  }   |  <   |  >   | , <  | ___  |
 * `-------------+------+------+------+-.------------.    ,------------.-+------+------+------+-------------'
 *               | LGUI | ___  | ___  |/ ___  / ___  /    \ ENT  \ ___  \| ___  | ___  | RGUI |
 *               |      |      |      /      /      /      \      \      \      |      |      |
 *               `---------------------------------'        `---------------------------------'
 *                                                                                   generated by [keymapviz] */
[LOWER] = LAYOUT( \
...
_______,  KC_GRV,   KC_EXLM,  KC_QUES,  KC_SLSH,  KC_BSLS,  _______,  _______,  KC_LCBR,  KC_RCBR,  KC_LT,    KC_GT,    KC_COMM,  _______, \
                    KC_LGUI,  _______,  _______,  _______,  _______,  KC_ENT,   _______,  _______,  _______,  KC_RGUI \
),

/* ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                    | PSLS |  7   |  8   |  9   | PMNS | BSPC |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |,------.    ,------.| PAST |  4   |  5   |  6   | PPLS |      |
 * |------+------+------+------+------+------|| ___  |    | ___  ||------+------+------+------+------+------|
 * |      |      |      |      |      |      |`------'    `------'|  0   |  1   |  2   |  3   | PDOT | PENT |
...
XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                      KC_PAST,  KC_4,     KC_5,     KC_6,     KC_PPLS,  XXXXXXX, \
XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  _______,  KC_0,     KC_1,     KC_2,     KC_3,     KC_PDOT,  KC_PENT, \
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | MEH  | HYPR |      | ESC  | ` ~  |                    | PGUP |WPREV |  UP  |WNEXT | DEL  | BSPC |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
XXXXXXX,  KC_MEH,   KC_HYPR,  XXXXXXX,  KC_ESC,   KC_GRV,                       KC_PGUP,  KC_WPREV, KC_UP,    KC_WNEXT, KC_DEL,    KC_BSPC, \
