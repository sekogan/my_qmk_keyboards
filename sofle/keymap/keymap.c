 ...
 * `-------------+------+------+------+-.------------.    ,------------.-+------+------+------+-------------'
 *               |Super | LALT |LCTRL |/LOWER / SPC  /    \ENT+Nu\RAISE \|RCTRL | RALT |Super |
 *               |      |      |      /      /      /      \      \      \      |      |      |
 *               `---------------------------------'        `---------------------------------'
...
XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                      KC_0,     KC_1,     KC_2,     KC_3,     KC_0,     KC_BSPC, \
XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                      KC_PPLS,  KC_4,     KC_5,     KC_6,     KC_PAST,  XXXXXXX, \
XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  _______,  KC_PMNS,  KC_7,     KC_8,     KC_9,     KC_PSLS,  KC_PDOT, \
